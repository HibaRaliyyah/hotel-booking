      ...
      <form className='flex bg-white rounded-xl max-w-4xl max-md:mx-2'>
        ...
        <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
          ...
          <div className='w-full mt-4'>
            <label for="name" className='font-medium text-gray-500'>
              Hotel Name
            </label>
          ...
          {/* Phone */}
          <div className='w-full mt-4'>
            <label for="contact" className='font-medium text-gray-500'>
              Phone
            </label>
          ...
          {/* Address */}
          <div className='w-full mt-4'>
            <label for="address" className='font-medium text-gray-500'>
              Address
            </label>
